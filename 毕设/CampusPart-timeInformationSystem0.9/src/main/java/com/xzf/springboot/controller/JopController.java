...
//        mongoTemplate.save(user,"JopDescriprions");//save 方法在_id 存在时更新数据 遍历慢
    ...
    ///fore/jopSearch-list搜索兼职
    @GetMapping("fore/jopSearch-list")
    @ResponseBody
    public ResultJop orderSearchList(Integer input,String input3, HttpSession session){
        List<Jop> jopsD=new ArrayList<>();
        JobDescription jobDescription;
        List<Jop> jopenddates=null;
        List<Jop> jops=null;
...
//        int input= Integer.parseInt(input1);
        ...
        jopenddates=jopService.orderSearchList(input,input3);
        ...
        jops=jopService.orderSearchList(input,input3);
